...
import { Map, Navigation, MapPin, Phone, Shield, ChevronRight, AlertTriangle } from "lucide-react";
            ...
            <section className="min-h-[80vh] flex items-center justify-center text-center py-20">
                <div className="w-full max-w-5xl mx-auto px-16">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center">
                        <Link
                            to="/explore"
                            className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-3 rounded-full font-medium transition-all"
                        >
                            <Map size={18} />
                        ...
                        <Link
                            to="/safe-route"
                            className="inline-flex items-center gap-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white px-6 py-3 rounded-full font-medium transition-all"
                        >
                            <Navigation size={18} />
                ...
                <div className="w-full max-w-6xl mx-auto px-16">
                    ...
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">
                            Everything You Need for <span className="text-emerald-400">Safe Travel</span>
                        </h2>
                        <p className="text-slate-400 max-w-2xl mx-auto">
                            Our comprehensive platform combines safety data, navigation, and emergency support to
                            ensure you have a worry-free travel experience.
                        </p>
                    </div>
            ...
            <section className="py-20">
                <div className="w-full max-w-6xl mx-auto px-16">
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        ...
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">
                                Understanding Our <span className="text-emerald-400">Safety Zones</span>
                            </h2>
                            <p className="text-slate-400 mb-8 leading-relaxed">
                                We analyze crime data from official sources to classify cities into three safety
                                zones, helping you make informed travel decisions.
                            </p>
                        ...
                        <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8 flex flex-col items-center justify-center min-h-[400px]">
                            ...
                            <p className="text-slate-500 mb-4 text-center">Interactive Safety Map</p>
                            <Link
                                to="/explore"
